$(document).ready(function ($) {
    ...
    var searchAutoComplete = function () {
        var listArea = ["An Giang", "Ba Ria - Vung Tau", "Bac Giang", "Bac Kan", "Bac Lieu", "Bac Ninh", "Ben Tre", "Binh Dinh", "Binh Duong", "Binh Phuoc", "Binh Thuan", "Nghe An", "Ho Chi Minh", "Ha Noi", "Da Nang", "Da Lat", "Hue", "Hai Phong"];
        $('.area').autocomplete({
            source: listArea
        });
    };
    ...
    var removeSearchBox = function () {
        $('#select2-id_label_single3-container').on("click", function () {
        ...
        $(".listroom").click(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    open_link.location = "/Payment/Index/" + data;
                }
            });
    ...
    //        var toAdd = $(".area").val();
    //        var nbpeople = $("#id_label_single3").val();
    //        var indate = $("#probootstrap-date-departure").val();
    //        var outdate = $("#probootstrap-date-arrival").val();
    ...
    //        $.ajax({
    //            type: "post",
    //            url: "/Home/BookingRoom",
    //            cache: false,
    //            contentType: "application/json",
    //            data: JSON.stringify(searchRoom),
    //            dataType: "json",
    //            success: function () {
    //                console.log("ok");
    //            }
